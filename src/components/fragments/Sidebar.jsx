...
export function Sidebar(){
    ...
    return(
        <div className="fixed xl:left-0 xl:top-0 z-[1000] bg-gradient-to-br from-bloods-950 via-bloods-950 to-bloods-700 h-dvh flex flex-col justify-between py-6 w-60">
            <div className="pl-2">
